...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Aeolus Grid', description: 'Monitor operațional pentru turbine eoliene.', images: ['/og.png'] },
  twitter: { card: 'summary_large_image', title: 'Aeolus Grid', description: 'Monitor operațional pentru turbine eoliene.', images: ['/og.png'] },
};
