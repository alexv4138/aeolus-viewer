...
export const ALERT_CATALOG: AlertRule[] = [
  ...
  { code: "ERR-015", parameter: "Presiune atmosferică anormală", description: "Modificarea bruscă de presiune poate indica o furtună iminentă.", severity: "info", action: "Pregătirea sistemului pentru rafale puternice.", notifications: "Notificare push și indicator meteo special în dashboard.", icon: "storm" },
